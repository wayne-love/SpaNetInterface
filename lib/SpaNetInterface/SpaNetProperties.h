...
public:
    ...
    */
    ...
    float getEC() { return EC.getValue(); }
    void setECCallback(void (*callback)(float)) { EC.setCallback(callback); }
    ...
    void setPump1OkToRunCallback(void (*callback)(bool)) { Pump2OkToRun.setCallback(callback); }
